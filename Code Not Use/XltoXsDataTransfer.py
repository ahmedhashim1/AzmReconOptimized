...
def main():
    ...
    excel_file = rf"{daily_file_path}\{m_year}\{path_month_abbr}\{m_day}\{daily_file_name}"  # Your daily file path
    access_db = r"D:\Freelance\Azm\DailyTrans.accdb"  # Your Access database path
